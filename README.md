...
&nbsp;  
&nbsp;  
Figure 21 shows a graphical representation of the classes and properties from the external
[WGS84 Geo Positioning ontology](https://github.com/nie-ine/Ontologies/blob/master/geo.ttl).  

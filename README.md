...
&nbsp;  
&nbsp;  
Figure 21 shows a graphical representation of the classes and properties from the external ontology ![figure](https://github.com/nie-ine/Ontologies/blob/master/other-ontologies/geo.ttl).  
